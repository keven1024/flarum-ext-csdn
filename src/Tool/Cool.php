...
{
    //    // 把0和1翻译成Boolean
    public static function toSerialize($Val): bool
    {
        return intval($Val) === 1 ? true : false;
    }

    public static function addPrefix($Key): string
    {
        return 'keven1024-csdn.' . $Key;
    }

    public static function addTrans($key): string
    {
        return 'keven1024-csdn.admin.settings.default.' . $key;
    }
